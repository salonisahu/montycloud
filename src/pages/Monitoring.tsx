            ...
            <Tooltip>
              ...
              <TooltipContent>
                <p className="max-w-xs">
                  Real-time system monitoring with interactive charts showing
                  CPU, memory, disk usage, and network performance metrics.
                </p>
              </TooltipContent>
            </Tooltip>
          </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 rounded-lg">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              24-hour CPU and memory utilization trends
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-64">
